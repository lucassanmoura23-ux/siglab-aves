...
export const Sidebar: React.FC<SidebarProps> = ({ currentView, onNavigate }) => {
  ...
  return (
    <div className="w-64 h-screen bg-white border-r border-gray-200 flex flex-col fixed left-0 top-0 overflow-y-auto z-10 shadow-xl">
      {/* Header / Logo Area */}
      <div className="p-10 flex flex-col items-center border-b border-gray-50 bg-gradient-to-b from-gray-50 to-white">
          ...
          <div>
            ...
            <div className="space-y-2">
              <div className="text-center">
                ...
                <p className="text-[8px] font-bold text-gray-500 leading-tight">Administrador - CRA-MT: 20-09385</p>
              </div>
              <div className="text-center">
